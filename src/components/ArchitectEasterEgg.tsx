...
export default function ArchitectEasterEgg() {
  ...
  useEffect(() => {
    ...
    console.log(
      "%c💡 Tip: Type 'esawi' on your keyboard to reveal the architect HUD.",
      "color: #94a3b8; font-style: italic; font-size: 11px; padding: 2px;"
    );
  }, []);

  // 2. Secret Keystroke Listener ("esawi", "idexi", "mahmoud")
  const handleKeyDown = useCallback((e: KeyboardEvent) => {
    ...
    if (/^[a-z]$/.test(char)) {
      bufferRef.current = (bufferRef.current + char).slice(-15);
      const str = bufferRef.current;
      if (
        str.endsWith("esawi") ||
        str.endsWith("idexi") ||
        str.endsWith("mahmoud")
      ) {
        setIsOpen(true);
        bufferRef.current = "";
      }
  ...
  useEffect(() => {
    ...
    // Also support custom event from click triggers
  ...
  return (
    <div className="architect-egg-backdrop" onClick={() => setIsOpen(false)}>
      ...
      >
        ...
        <div className="architect-header">
          <div className="architect-badge">
            ...
            <span>Lead Architect Interface</span>
          </div>
          <button
        ...
        <div className="architect-profile-row">
          <div className="architect-avatar-wrap">
            ...
            <div className="architect-avatar-inner">
              <Code2 size={26} color="#00f0ff" />
            </div>
          </div>
          <div>
            <div className="architect-role-tag">
              <Sparkles size={12} />
              <span>Full-Stack Architect & Core Lead</span>
            </div>
            <h2 id="architect-title" className="architect-name">Mahmoud Al-Esawi</h2>
